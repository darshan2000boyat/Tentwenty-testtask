                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center h-8">
                      ...
                      <span className="w-10 h-full flex items-center justify-center border select-none border-gray-300 outline-none focus:ring-2 focus:ring-blue-500">
                        {formik.values.hours}
                      </span>
                      <button
                        type="button"
